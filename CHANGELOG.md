...
- Add typed inventory snapshot, status, and history reads. Fetch and inspection methods are available in the SDK but currently unavailable in production; dispatch requests never retry automatically.
